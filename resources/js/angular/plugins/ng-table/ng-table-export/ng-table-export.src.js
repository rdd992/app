    ...
    return {
        ...
        link: function(scope, element, attrs) {
            ...
            var csv = {
                ...
                generateFromData: function(header, source, ids) {
                    data = '';
                    rowData = '';
                    var value;
                    
                    for(h in header){
                    	rowData += csv.stringify(header[h]) + ';';
                    }
                    ...
                    for(d in source){
                    	...
                    	value = '';
                    	for(id in ids){
                    		value = source[d][ids[id]] !== undefined && source[d][ids[id]] !== null ? source[d][ids[id]].toString() : '';
                    		rowData += csv.stringify(value) + ';';
                    	}
                    	data += rowData + "\n";
                    }
                },
